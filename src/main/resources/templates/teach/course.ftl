        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="teach/profile" class="waves-effect"><i class="fa fa-user fa-fw" aria-hidden="true"></i>信息修改</a>
                    </li>
                    <li>
                        <a href="teach/course" class="waves-effect"><i class="fa fa-table fa-fw" aria-hidden="true"></i>课程管理</a>
                    </li>
                    <li>
                        ...
                        <div class="white-box">
                            <form class="form-horizontal form-material">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input name="teachGrade" type="text" placeholder="Johnathan Doe"
                                               class="form-control form-control-line"> </div>
                                </div>
                                <div class="form-group">
